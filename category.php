...
<section class="single_category">
    <div class="container">
        <?php if(is_category(235)){ ?>
            <div class="row">
                <img class="w-100 h-100" src="<?php echo get_template_directory_uri(); ?>/inc/assets/images/mobile-main-image-min.jpg" alt="<?php echo single_cat_title(); ?>">
            </div>
            <div class="row text-center py-5">
                <h5>“من هون نحنا”، فقرة أسبوعية تنشرها منصة نقِد للإضاءة على حقبات واحداث تاريخية إرتبطت بكيان لبنان ونشأته.</h5>
            </div>
        <?php } else {?>
